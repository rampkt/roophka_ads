...
if(isset($_REQUEST['action'])and ($_REQUEST['action']=="_addtemplate")) {
	$bulkemail->id=$_REQUEST['id'];
	$bulkemail->name=$_REQUEST['name'];
	$bulkemail->content=$_REQUEST['content'];
		$bulkemail->templateupdate();
		redirect(HTTP_PATH . "admin/templates.php?success=5");
            ...
            <div class="row-fluid">
				...
				<div class="box span12">
					<div class="box-header">
						<h2><i class="halflings-icon white th"></i><span class="break"></span>Edit Template</h2>
					</div>
					<div class="box-content">
						
						<div class="tab-content">
							<div class="tab-pane active id="textadd">
								<form class="form-horizontal" name="templateform" method="post" action="template_edit.php" enctype="multipart/form-data">
                                <input type="hidden" name="action" value="_addtemplate" />
								 ...
								 <br>
                                    <div class="control-group">
                                      ...
                                      <div class="controls">
                                        <input type="text" class="input-xlarge" id="name" name="name" placeholder="Enter template name here..." value="<?=$edit['template_name']?>"  required />
                                      </div>
                                    </div>
									 ...
									 <div class="control-group ">
                                      ...
                                      <div class="controls">
                                        <textarea cols="50" class="cleditor" id="contentvalue" name="content" rows="10" required ><?=$edit['template_content']?>"</textarea>
