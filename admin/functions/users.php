...
class users
{
	...
	public function getAllUsers() {
		...
		$query = 'SELECT u.id, u.email, u.firstname, u.phone, u.status, u.account_balance, u.signupdate, u.demo, (SELECT COUNT(id) FROM roo_user_accounts AS ua WHERE ua.userid = u.id) AS bank FROM roo_users AS u WHERE u.status IN (0,1) LIMIT '.$this->start.','.$this->rowLimit;
		...
		$pagination = pagination("users.php", "", $this->page, $totalPage, 6);
